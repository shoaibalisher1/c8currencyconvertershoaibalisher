...
while (loop) {
    ...
    if (input === "PKR" && output === "USD") {
        console.log(`The ${amount} will be equivalent to USD ${amount * 0.0036}`);
    }
    else if (input === "USD" && output === "PKR") {
        console.log(`The ${amount} is equivalent to PKR ${amount * 280}`);
    }
    else if (input === "GBP" && output === "USD") {
        console.log(`The ${amount} will be equivalent to USD ${amount * 1.27}`);
    }
    else if (input === "USD" && output === "GBP") {
        console.log(`The ${amount} is equivalent to GBP ${amount * 0.79}`);
    }
    else if (input === "PKR" && output === "GBP") {
        console.log(`The ${amount} will be equivalent to GBP ${amount * 0.0028}`);
    }
    else if (input === "GBP" && output === "PKR") {
        console.log(`The ${amount} is equivalent to PKR ${amount * 353.52}`);
    }
